...
int main(int argc, char* argv[]) {
  ...
  if (option == "mesh") {
    ...
    visualization::DrawGeometries({rgbd_ptr}, "RGBD", depth_ptr->width_ * 2, depth_ptr->height_);
    ...
    if (argc == 3) {
      ...
      visualization::DrawGeometriesWithCustomAnimation({mesh_ptr}, "Animation", 1600, 900, 50, 50,
                                                       argv[3]);
    }
  }
